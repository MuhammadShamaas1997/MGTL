...
volume vyz=volume(vec(0,-ysize,-zsize),vec(0,ysize,zsize));
    ...
    double E_energy_In = f.electric_energy_in_box(box1);
    double E_energy_Out = f.electric_energy_in_box(box2);
    double M_energy_In = f.magnetic_energy_in_box(box1);
    double M_energy_Out = f.magnetic_energy_in_box(box2);
    cout<<"Electric Energy: "<<E_energy_In<<" : "<<E_energy_Out<<endl;
    cout<<"Magnetic Energy: "<<M_energy_In<<" : "<<M_energy_Out<<endl;     
