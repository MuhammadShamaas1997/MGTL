...
Lmax=40000-1;
subplot(2,2,1)
plot(((1:Lmax)*t0)/40,real(Hx(1:Lmax,2))*H0);hold on;
plot(((1:Lmax)*t0)/40,real(Hy(1:Lmax,2)*H0),'r');
...
subplot(2,2,3)
plot(((1:Lmax)*t0)/40,real(Hx(1:Lmax,10))*H0);hold on;
plot(((1:Lmax)*t0)/40,real(Hy(1:Lmax,10)*H0),'r');
