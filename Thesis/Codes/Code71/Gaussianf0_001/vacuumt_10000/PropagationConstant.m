...
%    dis=round(data{in}(2)*10+61);
    Hx(data{in}(1)/20,dis)=data{in}(3)+1i*data{in}(4);
    Hy(data{in}(1)/20,dis)=data{in}(5)+1i*data{in}(6);
    Hz(data{in}(1)/20,dis)=data{in}(7)+1i*data{in}(8);
    
    Bx(data{in}(1)/20,dis)=data{in}(9)+1i*data{in}(10);
    By(data{in}(1)/20,dis)=data{in}(11)+1i*data{in}(12);
    Bz(data{in}(1)/20,dis)=data{in}(13)+1i*data{in}(14);
    
    Ex(data{in}(1)/20,dis)=data{in}(15)+1i*data{in}(16);
    Ey(data{in}(1)/20,dis)=data{in}(17)+1i*data{in}(18);
    Ez(data{in}(1)/20,dis)=data{in}(19)+1i*data{in}(20);
   
    Dx(data{in}(1)/20,dis)=data{in}(21)+1i*data{in}(22);
    Dy(data{in}(1)/20,dis)=data{in}(23)+1i*data{in}(24);
    Dz(data{in}(1)/20,dis)=data{in}(25)+1i*data{in}(26);
...
Lmax=8552+10-1;
subplot(2,2,1)
plot(((1:Lmax)*t0)/20,real(Hx(1:Lmax,3))*H0);hold on;
plot(((1:Lmax)*t0)/20,real(Hy(1:Lmax,3)*H0),'r');
...
subplot(2,2,3)
plot(((1:Lmax)*t0)/20,real(Hx(1:Lmax,10))*H0);hold on;
plot(((1:Lmax)*t0)/20,real(Hy(1:Lmax,10)*H0),'r');
