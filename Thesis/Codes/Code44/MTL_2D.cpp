...
void my_material_func(vector3 p, void *user_data, meep_geom::medium_struct *m) {
  ...
  */
  ...
  /*m->E_chi2_diag.x = m->E_chi2_diag.y = m->E_chi2_diag.z = nn * nn;
  m->E_chi3_diag.x = m->E_chi3_diag.y = m->E_chi3_diag.z = nn * nn;
  ...
  m->B_conductivity_diag.x = m->B_conductivity_diag.y = m->B_conductivity_diag.z = nn * nn;
*/
  ...
  if (in_middle && data->with_susceptibility) {
    ...
    m->E_susceptibilities.items[0].sigma_diag.x = NiFe_sig;
    m->E_susceptibilities.items[0].sigma_diag.y = NiFe_sig;
    m->E_susceptibilities.items[0].sigma_diag.z = NiFe_sig;
    m->E_susceptibilities.items[0].bias.x = NiFe_sig;
    m->E_susceptibilities.items[0].bias.y = NiFe_sig;
    m->E_susceptibilities.items[0].bias.z = NiFe_sig;
    m->E_susceptibilities.items[0].frequency = NiFe_frq;
    m->E_susceptibilities.items[0].gamma = NiFe_gam;
    m->E_susceptibilities.items[0].alpha = NiFe_sig;
    ...
    m->H_susceptibilities.items[0].bias.x = NiFe_sig;
    m->H_susceptibilities.items[0].bias.y = NiFe_sig;
    m->H_susceptibilities.items[0].bias.z = NiFe_sig;
