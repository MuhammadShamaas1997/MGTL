...
int main(int argc, char *argv[]) {
  ...
  {for (double y=-12.5;y<=12.5;y=y+00.1){
    ...
    my_medium_struct.H_chi2_diag.x=1e-2;
    my_medium_struct.H_chi2_diag.y=1e-2;
    my_medium_struct.H_chi2_diag.z=1e-2;
    my_medium_struct.H_chi3_diag.x=1e-2;
    my_medium_struct.H_chi3_diag.y=1e-2;
    my_medium_struct.H_chi3_diag.z=1e-2;
