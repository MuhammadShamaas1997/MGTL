...
void my_material_func(vector3 p, void *user_data, meep_geom::medium_struct *m) {
  ...
  m->E_chi2_diag.x = m->E_chi2_diag.y = m->E_chi2_diag.z = 1000000.0;
  m->E_chi3_diag.x = m->E_chi3_diag.y = m->E_chi3_diag.z = 1000000.0;
  m->H_chi2_diag.x = m->H_chi2_diag.y = m->H_chi2_diag.z = 1000000.0;
  m->H_chi3_diag.x = m->H_chi3_diag.y = m->H_chi3_diag.z = 1000000.0;
