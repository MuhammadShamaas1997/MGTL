...
void my_material_func(vector3 p, void *user_data, meep_geom::medium_struct *m) {
  ...
  if (in_middle)
  {
    ...
    m->H_susceptibilities.items[0].sigma_diag.x = gaussian_random(100.0,1.0);//NiFe_sig;
    m->H_susceptibilities.items[0].sigma_diag.y = gaussian_random(100.0,1.0);//NiFe_sig;
    m->H_susceptibilities.items[0].sigma_diag.z = gaussian_random(100.0,1.0);//NiFe_sig;
    ...
    m->H_susceptibilities.items[0].gamma = 10.0*((0.2e6)/f0);//NiFe_gam;
...
int main(int argc, char *argv[]) {
  ...
  {for (double y=-12.5;y<=12.5;y=y+00.1){
    ...
    */my_medium_struct.H_chi2_diag.x=1e-3;
    ...
    my_medium_struct.H_susceptibilities.num_items = 2;
    my_medium_struct.H_susceptibilities.items = new meep_geom::susceptibility[2];
    ...
    my_medium_struct.H_susceptibilities.items[0].sigma_diag.x = gaussian_random(100.0,1.0);
    my_medium_struct.H_susceptibilities.items[0].sigma_diag.y = gaussian_random(100.0,1.0);
    my_medium_struct.H_susceptibilities.items[0].sigma_diag.z = gaussian_random(100.0,1.0);
    ...
    my_medium_struct.H_susceptibilities.items[0].gamma = 10.0*(0.2e6/f0);
    ...
    my_medium_struct.H_susceptibilities.items[1].sigma_offdiag.x = 0.0;
    my_medium_struct.H_susceptibilities.items[1].sigma_offdiag.y = 0.0;
    my_medium_struct.H_susceptibilities.items[1].sigma_offdiag.z = 0.0;
    my_medium_struct.H_susceptibilities.items[1].sigma_diag.x = NiFe_sig;
    my_medium_struct.H_susceptibilities.items[1].sigma_diag.y = NiFe_sig;
    my_medium_struct.H_susceptibilities.items[1].sigma_diag.z = NiFe_sig;
    my_medium_struct.H_susceptibilities.items[1].bias.x = 0.0;
    my_medium_struct.H_susceptibilities.items[1].bias.y = 0.0;
    my_medium_struct.H_susceptibilities.items[1].bias.z = 0.0;
    my_medium_struct.H_susceptibilities.items[1].frequency = (NiFe_frq);
    my_medium_struct.H_susceptibilities.items[1].gamma = NiFe_gam;
    my_medium_struct.H_susceptibilities.items[1].alpha = 0.0;
    my_medium_struct.H_susceptibilities.items[1].noise_amp = 0.01;
    my_medium_struct.H_susceptibilities.items[1].drude = true;
    my_medium_struct.H_susceptibilities.items[1].saturated_gyrotropy = false;
    my_medium_struct.H_susceptibilities.items[1].is_file = false;
 ...
 for (double fp=0.0;fp<=10.0*(1e9/f0);fp=fp+0.5*(1e9/f0))
    { cout<<fp<<endl;
      for (double yp = -20.0; yp <= 20.0; yp=yp+5.0)
      {
    ...
    //f_range;1e-5,1e-2
    double fcen = (5e9)/f0; // ; pulse center frequency
    double df = 0.999999*((5e9)/f0);    // ; df
